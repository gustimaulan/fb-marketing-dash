<template>
  <div v-if="showDebugger" class="fixed bottom-4 right-4 bg-white border border-gray-300 rounded-lg shadow-lg p-4 max-w-md z-50">
    ...
    <div class="space-y-2 text-xs">
      <div v-for="(info, key) in cacheInfo" :key="key" class="flex justify-between">
      ...
      <div class="pt-2 border-t border-gray-200">
        ...
        <div class="flex justify-between mb-2">
          <span class="font-medium">Data Records:</span>
...
const { loading, error, allData, useSampleDataFallback } = storeToRefs(dashboardStore)
const { getCacheInfo, clearAllCaches, refreshData } = dashboardStore
